...
@Component({
  selector: 'app-rebuttals-own',
  templateUrl: './rebuttals-own.component.html',
  styleUrls: ['./rebuttals-own.component.css']
})
export class RebuttalsOwnComponent implements OnInit {
